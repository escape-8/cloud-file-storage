$(document).ready(function () {
    ...
    function uploadFile(file) {
        ...
        if (checkMaxFileSize(file)) {
            uploadResponse(fileName, id, file);
            return;
        }
    ...
    function uploadResponse (fileName, id, file) {
                            ...
                            <div id="${id}" class="d-flex flex-row align-items-center bg-light w-100 rounded-3 p-3 mb-1" >
                                ...
                                <div class="d-flex flex-column w-100" style="max-width: 90%">
                                    <div id="header-${id}" class="d-flex flex-row align-items-center justify-content-between mb-2">
                                        <div class="d-flex w-75 flex-row align-items-center">
                                            <div class="text-truncate w-50 me-2">${fileName}</div>
                                            <span class="me-3 text-nowrap">${filesizeMB} MB</span>
                                        </div>
                                        <div class="d-flex flex-row">0 %</div>
                                    </div>
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="progress w-100" style="height: 10px">
        ...
        $(`#${id}`).after(`<span class="invalid-feedback d-inline-block" role="alert"><strong class="text-wrap">This file must not be greater than 20 megabytes</strong></span>`);
    }
});
